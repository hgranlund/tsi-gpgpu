...
void printPoints(float* l, int n){
  ...
  TEST(kernels, radix_selection){
    ...
    // print last bit and shift left.
      ...
      float *d_points, *d_result, h_result, *d_ones, *d_zeros;
      h_result = 0;
      checkCudaErrors(
      ...
      checkCudaErrors(
        cudaMalloc((void **)&d_zeros, n*sizeof(float)));
      ...
      cuRadixSelect<<<1,8>>>(d_points, n/2, n, d_ones, d_zeros, d_result);
      checkCudaErrors(
