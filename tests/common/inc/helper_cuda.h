...
static const char *_cudaGetErrorEnum(cudaError_t error)
{
    ...
    case cudaErrorInvalidHoststruct Pointer:
        return "cudaErrorInvalidHoststruct Pointer";

    case cudaErrorInvalidDevicestruct Pointer:
        return "cudaErrorInvalidDevicestruct Pointer";
