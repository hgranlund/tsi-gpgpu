...
The purpose of this chapter is to cover some background material for the research presented in this thesis. A introduction to the kNN problem is given, and its relation to the problem of associative retrieval, all-kNN, and q-kNN is discussed. A presentation of common parallel programming 


\section{A short introduction to the kNN algorithm} % (fold)
...
Include a transition into the TSI use-case. Fixed 3D points, large volume of repeated queries on large point cloud.

% section a_short_introduction_to_the_kNN_algorithm (end)
