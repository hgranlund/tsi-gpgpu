...
\subsection{Development of a parallel kd-tree build algorithm} % (fold)
\label{sub:development_of_a_parallel_kd_tree_build_algorithm}

\include{development_of_a_parallel_kd_tree_build_algorithm}
% subsection development_of_a_parallel_kd_tree_build_algorithm (end)
