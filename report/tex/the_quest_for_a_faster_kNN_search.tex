...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=100mm]{../gfx/kd_tree_illustration_graph.png}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=100mm]{../gfx/kd_tree_illustration_tree.png}
...
\begin{enumerate}
\item 32 threads in a warp, occupasity,
%see http://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#occupancy
\item Aritmetic optimalisation
