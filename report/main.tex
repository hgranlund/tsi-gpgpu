...
\newcommand{\mytitle}{Integrating general-purpose software design tools into KBE-development}
...
\include{./tex/part1_the_kbe_system}
\include{./tex/part2_extending_aml}
\include{./tex/part3_building_a_kbe_system}
\include{./tex/part4_discusion_and_concution}
% include content
%\include{./tex/test}
